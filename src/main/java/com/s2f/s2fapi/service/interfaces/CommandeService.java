...
public interface CommandeService {
    ...
    CommandeDtoResponse updateEtatCommande(CommandeDtoResponse commandeDtoResponse);
    List<CommandeProduitDtoResponse> getCommandeProduitByCommandeId(Long commandeId);
    CommandeDtoResponse archiveCommande(Long id);
}
